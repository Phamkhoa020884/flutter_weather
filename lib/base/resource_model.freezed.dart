...
class _$Success<T> with DiagnosticableTreeMixin implements Success<T> {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResourceModel<$T>.success(value: $value)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ResourceModel<$T>.success'))
...
abstract class Success<T> implements ResourceModel<T> {
...
class _$Loading<T> with DiagnosticableTreeMixin implements Loading<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'ResourceModel<$T>.loading'));
  }
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$ResourceModelCopyWithImpl<T, $Res>
...
class _$Error<T> with DiagnosticableTreeMixin implements Error<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResourceModel<$T>.error(message: $message)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResourceModel<$T>.error'))
...
abstract class Error<T> implements ResourceModel<T> {
